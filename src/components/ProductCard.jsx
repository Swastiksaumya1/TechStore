  ...
  return (
    <div className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm hover:shadow-md transition-all duration-300">
      ...
      <div className="p-5 flex flex-col justify-between h-[220px]">
        <div>
          <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white line-clamp-1" title={product.title}>
            {product.title}
          </h5>
          <p className="mt-1 text-sm font-medium text-gray-500 dark:text-gray-400">
            {product.author}
          </p>
          <p className="mt-2 text-gray-600 dark:text-gray-300 text-sm line-clamp-2" title={product.description}>
            {product.description}
          </p>
        </div>
